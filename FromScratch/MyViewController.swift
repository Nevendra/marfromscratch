...
//  FromScratch
//
//  Created by Nseo on 3/2/16.
//  Copyright © 2016 NYCDAthree. All rights reserved.
//
...
class MyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let additionalView = UIView(frame: CGRect(x: 100, y: 100, width: 50, height: 50))
        additionalView.backgroundColor = UIColor.redColor()
        self.view.addSubview(additionalView)
        
        let additionalView2 = UIView(frame: CGRect(x: 200, y: 100, width: 50, height: 50))
        ...
        let burritoImage = UIImage(named: "aburrito")
